...
test("@datadog/pprof", () => import("@datadog/pprof").then(assert.ok));
...
test("@sentry/minimal", () => import("@sentry/minimal").then(assert.ok));
...
test("ps-tree", () => import("ps-tree").then(assert.ok));
...
test("stylus", () => import("stylus").then(assert.ok));
