...
test("@ardatan/sync-fetch", () => import("@ardatan/sync-fetch").then(assert.ok));
...
test("@graphql-codegen/cli", () => import("@graphql-codegen/cli").then(assert.ok));
...
test("babel-plugin-module-resolver", () => import("babel-plugin-module-resolver").then(assert.ok));
...
test("buffer-writer", () => import("buffer-writer").then(assert.ok));
...
test("eslint-plugin-eslint-comments", () => import("eslint-plugin-eslint-comments").then(assert.ok));
...
test("esm", () => import("esm").then(assert.ok));
...
test("junk", () => import("junk").then(assert.ok));
...
test("metro", () => import("metro").then(assert.ok));
test("metro-babel-transformer", () => import("metro-babel-transformer").then(assert.ok));
test("metro-cache", () => import("metro-cache").then(assert.ok));
test("metro-config", () => import("metro-config").then(assert.ok));
test("metro-core", () => import("metro-core").then(assert.ok));
test("metro-resolver", () => import("metro-resolver").then(assert.ok));
test("metro-runtime", () => import("metro-runtime").then(assert.ok));
...
test("packet-reader", () => import("packet-reader").then(assert.ok));
...
test("pixelmatch", () => import("pixelmatch").then(assert.ok));
...
test("react-native", () => import("react-native").then(assert.ok));
...
test("use-resize-observer", () => import("use-resize-observer").then(assert.ok));
