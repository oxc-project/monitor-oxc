...
test("@angular-devkit/architect", () => import("@angular-devkit/architect").then(assert.ok));
...
test("@pkgr/utils", () => import("@pkgr/utils").then(assert.ok));
...
test("es6-error", () => import("es6-error").then(assert.ok));
test("es6-iterator", () => import("es6-iterator").then(assert.ok));
test("es6-promise", () => import("es6-promise").then(assert.ok));
test("es6-promisify", () => import("es6-promisify").then(assert.ok));
test("es6-symbol", () => import("es6-symbol").then(assert.ok));
test("es6-weak-map", () => import("es6-weak-map").then(assert.ok));
...
test("event-emitter", () => import("event-emitter").then(assert.ok));
...
test("js-beautify", () => import("js-beautify").then(assert.ok));
...
test("memoizee", () => import("memoizee").then(assert.ok));
...
test("react-inspector", () => import("react-inspector").then(assert.ok));
