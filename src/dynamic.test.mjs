...
test("@tailwindcss/vite", () => import("@tailwindcss/vite").then(assert.ok));
...
test("c8", () => import("c8").then(assert.ok));
...
test("canvg", () => import("canvg").then(assert.ok));
...
test("codemirror", () => import("codemirror").then(assert.ok));
